...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($username === $default_username && $password === $default_password) {
        $_SESSION['user_id'] = 1; // Tu peux mettre 1 pour Admin
        $_SESSION['role'] = 'admin';
...
<head>
    <meta charset="UTF-8">
    <title>Connexion Administrateur - StartUp Manager</title>
...
<div class="card shadow p-4" style="width: 400px;">
    ...
    <form method="POST">
        ...
        <div class="text-center mt-3">
            <a href="login.php" class="btn btn-outline-secondary btn-sm">← Retour Connexion Utilisateur</a>
        </div>
    </form>
</div>
